                            ...
                            <div className="cursor-pointer flex items-end justify-end">
                                ...
                                <div className="flex flex-wrap justify-center items-center gap-4">
                                    {drillDownData.map((item) => (
                                        ...
                                        <p className="m-0 text-white whitespace-nowrap mt-3 cursor-pointer" onClick={() => setShowEditSPlantSFacModal(true)}><CiEdit/></p>
                                            ...
                                            <div className="bg-slate-900">
                                                ...
                                                <div className="relative my-6 mx-auto w-[800px]">
                                                    ...
                                                    <div className="mb-4 mt-2">
                                                        ...
                                                        id="system"
                                                        name="system"
                                                        value={selectedEditSystem}
                                                        onChange={handleSystemEditChange}
                                                        //value={system}
                                                        //onChange={(e) => setName(e.target.value)}
                                                        className="mt-1 ml-[-10px] p-2 border border-gray-300 rounded-md w-[740px] h-[35px]"
                                                        >
                                                ...
                                                {!showDropDownSPlantSFac && (
                                                    <>
                                                <div className=" font-semibold text-[15px] overflow:hidden" onClick={() => handleItemClick(item._id, item.level)}>
