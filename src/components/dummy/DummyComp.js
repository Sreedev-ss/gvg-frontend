...
const DummyComp = () => {
    ...
    return (
        <div className="bg-white p-4 h-[89.4vh] rounded-lg shadow-md">
            ...
            <div className=" w-[95%] h-[92%] bg-green-50 m-6">
                <div className='m-15 '>
                    ...
                    <div className='flex items-center justify-center m-16 mt-5'>
                        <div className="rounded-6xl  py-2 px-[15px] box-border ml-[-66px] bg-green-200 rounded-2xl w-[20%]" onClick={() => fetchData(parentName?.parent)}>
                        ...
                        <div className='absolute mt-0 left-0 top-60'>
                            <div className="text-center text-xl text-white bg-green-200 rounded-2xl ml-[310px] mt-[30px] w-[131vh] h-[64vh]">
